      ...
      <div className='header'>
        <div className='logo'>
          <div style={{display: 'flex', gap: '5px'}}>
            <h4 style={{color: 'white', fontSize: '12px'}}>Get early access on launches and offers.</h4>
            <h4 style={{
              color: 'white',
              fontSize: '12px',
              fontWeight: 'normal',
      ...
      <div style={{width: '1400px', height: '56px'}}>
        <div style={{
          ...
          >
            ...
            >
              <h4 className={`hover-line ${activeLink === 'women' ? 'active' : ''}`}>
                Women
              </h4>
            </Link>
            <Link
            ...
            >
              <h4 className={`hover-line ${activeLink === 'men' ? 'active' : ''}`}>
                Men
              </h4>
            </Link>
            <Link
            ...
            >
              <h4 className={`hover-line ${activeLink === 'about' ? 'active' : ''}`}>
                About
              </h4>
            </Link>
            <Link
              style={{ textDecoration: 'none', color: 'black' }}
              to="ever-world"
              onClick={() => handleLinkClick('ever-world')}
            >
              <h4 className={`hover-line ${activeLink === 'ever-world' ? 'active' : ''}`}>
                Everworld Stories
              </h4>
            </Link>
          </div>

          <div style={{paddingRight: '200px'}}><img src={everlane} alt=""/></div>
          <div style={{
            width: '120px',
            height: '40px',
            display: 'flex',
